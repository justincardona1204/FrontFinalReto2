...
const URL_BASE = "http://152.67.253.190:8080/api/";
    ...
    if ($.trim($("#emailRegistro").val()) == "" || $.trim($("#usuarioRegistro").val()) == "" || $.trim($("#contrasenaRegistro").val()) == "" || $.trim($("#contrasenaRegistro2").val()) == "") {
        alert("Por favor ingrese todos los campos");
         ...
         if ($("#contrasenaRegistro").val() == $("#contrasenaRegistro2").val()) {
            let datos = jsonDatos();
            let url = "http://152.67.253.190:8080/api/user/emailexist/"+datos.email;
...
let emailExiste = function(response){
    if(response){
        ...
        let url = "http://152.67.253.190:8080/api/user/new";
...
function validarEmail() {
    ...
    $.ajax({
        url: "http://152.67.253.190:8080/api/user/emailexist/" + email,
        method: "GET",
        dataType: "json",
        success: function (response) {
            console.log(response);
...
function consultarUsuario() {
    $.ajax({
        url: "http://152.67.253.190:8080/api/user/all",
        type: "GET",
        datatype: "JSON",
        success: function (response) {
            $("#miTabla").empty();
...
$("#editarUsuario").click(function() {
    ...
    $.ajax({
        ...
        data: dataToSend,
        contentType: 'application/json',
        url: "http://152.67.253.190:8080/api/user/update",
        type: 'PUT',
        success: function (response) {
            console.log(response);
...
function buscarPorIDUsuario(idItem) {
    $.ajax({
        url: "http://152.67.253.190:8080/api/user/" + idItem,
        type: "GET",
        datatype: "JSON",
        success: function (response) {
            console.log(response)
...
function eliminarUsuario(idElemento) {
    ...
    $.ajax({
      url: "http://152.67.253.190:8080/api/user/" + idElemento,
      type: "DELETE",
      data: datoEnvio,
      datatype: "json",
      contentType: 'application/json',
...
$("#guardarInventario").click(function () {
    if ($.trim($("#brandRegistro").val()) == "" || $.trim($("#procesorRegistro").val()) == "" || $.trim($("#osRegistro").val()) == "" || $.trim($("#descriptionRegistro").val()) == "" || $.trim($("#memoryRegistro").val()) == "" || $.trim($("#hardDriveRegistro").val()) == "" || $.trim($("#availabilityRegistro").val()) == "" || $.trim($("#priceRegistro").val()) == "" || $.trim($("#quantityRegistro").val()) == "" || $.trim($("#photographyRegistro").val()) == "") {
        ...
        $.ajax({
            url: "http://152.67.253.190:8080/api/clone/new",
            method: "POST",
            dataType: "JSON",
...
function consultarInventario() {
    $.ajax({
        url: "http://152.67.253.190:8080/api/clone/all",
        type: "GET",
        datatype: "JSON",
        success: function (response) {
            $("#miTablaInventario").empty();
...
$("#editarInventario").click(function() {
    ...
    $.ajax({
        ...
        data: dataToSend,
        contentType: 'application/json',
        url: "http://152.67.253.190:8080/api/clone/update",
        type: 'PUT',
        success: function (response) {
            console.log(response);
            alert("Actualizado Correctamente :D");
...
function buscarPorIDInventario(idItem) {
    $.ajax({
        url: "http://152.67.253.190:8080/api/clone/" + idItem,
        type: "GET",
        datatype: "JSON",
        success: function (response) {
            console.log(response)
...
function eliminarInventario(idElemento) {
    ...
    console.log(datoEnvio);
    $.ajax({
      url: "http://152.67.253.190:8080/api/clone/" + idElemento,
      type: "DELETE",
      data: datoEnvio,
      datatype: "json",
      contentType: 'application/json',
